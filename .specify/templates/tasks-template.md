...
**Tests**: Include tasks for every applicable constitutional test obligation. Deterministic
components require fixture-backed unit tests; LLM paths require recorded-fixture contract
tests and a Make-runnable live smoke test; OpenSCAD paths require the three mandated
negative tests; CI must run without a GPU using mocked Ollama.
...
- [ ] T010 Create shared Zod API and SSE schema package with server/client consumers
- [ ] T011 Configure typed SSE progress states for operations over two seconds
- [ ] T012 Configure GPU-free CI fixtures and mocked Ollama execution
...
### Tests for User Story 1 (required when the story exercises governed behavior) ⚠️
...
### Tests for User Story 2 (required when the story exercises governed behavior) ⚠️
...
### Tests for User Story 3 (required when the story exercises governed behavior) ⚠️
...
- [ ] TXXX [P] Add required fixture-backed unit tests in tests/unit/
