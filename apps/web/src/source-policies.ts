...
/**
 * Application-owned ingestion allowlist. Background n8n workflows may submit
 * records only through the authenticated upsert API; they never receive
 * database credentials or direct table access.
 */
export const applicationSourcePolicies: readonly SourcePolicy[] = [
  {
    id: "espressif-documentation",
    revision: 1,
    enabled: true,
    ...
    allowedFacts: ["citation", "documentation", "part_metadata", "cad_metadata"],
    refresh: { intervalHours: 720, maxStalenessHours: 2160 },
    terms: {
      evidenceRequired: true,
      acceptedStatuses: ["public-documentation", "redistribution-permitted"],
      prohibitedUses: ["automated-login", "browser-automation", "unapproved-scraping"],
    },
    cadAssets: {
      sourceUrlRequired: true,
      identifiableLicenseRequired: true,
      allowedLicenses: ["CC0-1.0", "CC-BY-4.0", "CC-BY-SA-4.0"],
      rejectAmbiguousLicense: true,
    },
  },
  {
    id: "bosch-sensortec-documentation",
    revision: 1,
    enabled: true,
    sourceClass: "documentation",
    allowedUrlPatterns: [
      "https://www.bosch-sensortec.com/products/environmental-sensors/**",
      "https://www.bosch-sensortec.com/media/**",
    ],
    allowedFacts: ["citation", "documentation", "part_metadata", "cad_metadata"],
    refresh: { intervalHours: 720, maxStalenessHours: 2160 },
    terms: {
