...
test("quickstart serves fixture-safe discovery, SSE, static assets, and the six-tab Workshop shell", async () => {
  ...
  try {
    ...
    assert.match(sandbox, /const tabs = \["Dashboard", "Research", "Parts", "Build", "Wiring", "Workshop"\] as const/);
  } finally {
