...
export const weatherStationGoldenSteps: readonly StepPlan[] = [
  step(
    ...
    "Identify the ESP32 microcontroller, BME280 sensor, breadboard, power source, and enclosure.", "none",
  ...
  {
    ...step(
      "10000000-0000-4000-8000-000000000002", 2, "Place the ESP32 microcontroller",
      "Seat the ESP32 microcontroller so both header rows have independent breadboard rows.", "mechanical",
      "Keep every controller pin reachable",
      "The ESP32 microcontroller header rows need separate breadboard rows so later connections stay independent and inspectable. Starting with this spacing makes it possible to trace a wire back to a named pin instead of guessing which contacts share a row.",
      "Both ESP32 microcontroller header rows sit on separate breadboard rows with their pins accessible.",
      cite.esp32,
    ),
  ...
  {
    ...step(
      "10000000-0000-4000-8000-000000000003", 3, "Place the BME280 sensor",
      "Place the BME280 sensor where its header can reach the ESP32 microcontroller with short jumper wires.", "mechanical",
      ...
      "The BME280 sensor header is reachable from the ESP32 microcontroller with short, uncrossed jumper paths.",
      cite.bme280,
    ),
  ...
  step(
    ...
    "Connect BME280 sensor GND to an ESP32 microcontroller GND pin.", "none",
    ...
    "A single jumper visibly connects the BME280 sensor GND label to an ESP32 microcontroller GND pin.",
    cite.bme280,
  ),
  step(
    "10000000-0000-4000-8000-000000000005", 5, "Connect sensor power",
    "Connect BME280 sensor VIN to the ESP32 microcontroller 3V3 supply.", "none",
    "Use the documented supply rail",
    "The reference build powers the sensor from the ESP32 microcontroller's regulated 3.3 V rail. Reading the cited pin and sensor documentation together helps you follow the named power path instead of inferring a connection from wire color or physical position.",
    "A single jumper visibly connects BME280 sensor VIN to the ESP32 microcontroller 3V3 pin.",
    cite.bme280,
  ),
  step(
    "10000000-0000-4000-8000-000000000006", 6, "Wire I2C data",
    "Connect BME280 sensor SDA to the ESP32 microcontroller I2C data pin.", "none",
    ...
    "A single jumper visibly connects BME280 sensor SDA to the ESP32 microcontroller SDA or GPIO21 pin shown in the cited guide.",
    cite.bme280,
  ),
  step(
    "10000000-0000-4000-8000-000000000007", 7, "Wire I2C clock",
    "Connect BME280 sensor SCL to the ESP32 microcontroller I2C clock pin.", "none",
    ...
    "A single jumper visibly connects BME280 sensor SCL to the ESP32 microcontroller SCL or GPIO22 pin shown in the cited guide.",
    cite.bme280,
  ),
  {
    ...step(
  ...
  step(
    ...
    "You have traced 3V3, GND, SDA, and SCL from the BME280 sensor labels to their ESP32 microcontroller endpoints.",
    cite.solder,
  ),
  {
    ...step(
